...
// --------------- 10 truy vấn nâng cao ---------------
		...
		begin_query2 = Calendar.getInstance().getTimeInMillis();
		query2.Query5("https://search.maven.org/artifact/org.neo4j/neo4j-kernel/3.5.0/jar");
		end_query2 = Calendar.getInstance().getTimeInMillis();
